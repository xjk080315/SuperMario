...
class Level:
    ...
    def load_map_data(self):
        ...
        with open(file_path) as f:
            self.map_date = json.load(f)

    def setup_background(self):
        self.image_name = self.map_date['image_name']
    ...
    def setup_start_position(self):
        self.position = []
        for data in self.map_date['maps']:
    ...
    def setup_ground_items(self):
        ...
        for name in ['ground', 'pipe', 'step']:
            for item in self.map_date[name]:
    ...
    def setup_bricks_and_boxes(self):
        ...
        if 'brick' in self.map_date:
            for brick_data in self.map_date['brick']:
        ...
        if 'box' in self.map_date:
            for box_data in self.map_date['box']:
    ...
    def setup_enemies(self):
        ...
        for enemy_group_data in self.map_date['enemy']:
    ...
    def setup_checkpoint(self):
        ...
        for item in self.map_date['checkpoint']:
    ...
    def update_player_position(self):
        ...
        # y direction
        if not self.player.death_timer:
